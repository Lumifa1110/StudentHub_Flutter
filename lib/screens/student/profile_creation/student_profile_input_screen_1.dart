        ...
        child: Container(
          ...
          child: Column (
            children: [
              ...
              // Divider
              Container(
                margin: const EdgeInsets.only(top: 30, bottom: 10), // Adjust the margin as needed
                child: const Divider(
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      alignment: Alignment.topLeft,
                      child: const Text('Vietnamese: Native\nEnglish: Bilingual',
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.normal
                        ),
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      alignment: Alignment.topLeft,
                      child: const Text('Tran Dai Nghia highschool for the gifted\n2013-2020',
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.normal
                        ),
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      padding: const EdgeInsets.only(top: 10),
                      alignment: Alignment.topLeft,
                      child: const Text('Ho Chi Minh University of Science\n2020-2024',
                        style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.normal
                        ),
              ...
              Container(
                ...
                child: ButtonSimple(
                  label: 'Next', 
                  onPressed: () => {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => StudentProfileInputScreen2(studentSkillsets: studentSkillsets,)))
                  }
                ),
              )
            ],
